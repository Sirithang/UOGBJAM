...
public class PlayerInput : MonoBehaviour
{
    ...
    protected DIRECTION _currentDirection = DIRECTION.DOWN;

    readonly int SPEED_HASH = Animator.StringToHash("Speed");
    readonly int DIRECTION_HASH = Animator.StringToHash("Direction");
    ...
    public void HandleInput()
    {
        ...
        m_animator.SetFloat(SPEED_HASH, move.magnitude);
        ...
        m_animator.SetFloat(DIRECTION_HASH, (int)_currentDirection / 3.0f);
